...
# Change source to file name to parse file
    sources = [[0],
        ["Training_Data/Squats/Good_Pose/Side_View2.mp4","Training_Data/Squats/Bad_Pose/Butt/Side_View.mp4","Training_Data/Squats/Bad_Pose/Knee/Side_View2.mp4"],
        ["Training_Data/Squats/Good_Pose/Front_View6.mp4","Training_Data/Squats/Bad_Pose/Knee/Front_View4.mp4"],
    ...
    # enable threading
    visual_node = visual.Node(source=sources[3][0],threading = False)
